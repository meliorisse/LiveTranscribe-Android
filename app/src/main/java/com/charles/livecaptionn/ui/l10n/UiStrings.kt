...
object UiStringCatalog {
    ...
    val ALL: List<String> = listOf(
        ...
        "Your translation server detects the text language. Restart captioning after changing speech-language settings.",
        "Auto-detect language",
        "Offline speech-language detector",
        "Optional download: 103 MB. Audio stays on this device. Requires a Vosk model for each enabled language.",
        "Downloading detector: %d%%",
        "Detector ready",
        "Remove detector",
        "Download detector",
        "Enabled speech languages (none selected means all installed):",
        "Download more Vosk languages from the source-language picker. Your selected source language remains the fallback.",
        ...
        "Uncertain text detection falls back to the selected source language. Restart captioning after changing speech-language settings.",
        "Detected text language: %s",
        "Language uncertain; using %s",
        "Detected language is not supported for on-device translation; using %s",
        "Language detection unavailable; using %s",
        "Close",
        "Choose language",
        "Search",
        "Requires Pro",
